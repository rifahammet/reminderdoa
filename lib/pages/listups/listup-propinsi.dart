...
class ListUpPropinsiDialog extends StatefulWidget {
  const ListUpPropinsiDialog({Key? key}) : super(key: key);
  @override
  _ListUpPropinsiDialogState createState() => _ListUpPropinsiDialogState();
}

class _ListUpPropinsiDialogState extends State<ListUpPropinsiDialog> {
