...
class ListUpKelurahanDialog extends StatefulWidget {
  final String? kecamatan_kode;
  const ListUpKelurahanDialog({Key? key,this.kecamatan_kode}) : super(key: key);
  @override
  _ListUpKelurahanDialogState createState() => _ListUpKelurahanDialogState();
}

class _ListUpKelurahanDialogState extends State<ListUpKelurahanDialog> {
  ...
  Future getDataKebun(
    ...
    final dataPropinsi = auth.getGlobalParam(
        namaApi: "kelurahan", like: txtFilter.text.toString().trim()!=""? { "active": "1","kec_kode": widget.kecamatan_kode,"concat_field": txtFilter.text}:{ "active": "1","kec_kode": widget.kecamatan_kode}, startFrom: (iPos-1) * int.parse(_selectedType.toString()) , limit: _selectedType);
