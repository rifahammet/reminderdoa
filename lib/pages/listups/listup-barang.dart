...
class ListUpBarangPage extends StatefulWidget {
  const ListUpBarangPage({Key? key}) : super(key: key);
  @override
  _ListUpBarangPageState createState() => _ListUpBarangPageState();
}

class _ListUpBarangPageState extends State<ListUpBarangPage> {
