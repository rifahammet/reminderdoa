...
class ListUpKotaDialog extends StatefulWidget {
  final String? propinsi_kode;
  const ListUpKotaDialog({Key? key, this.propinsi_kode}) : super(key: key);
  @override
  _ListUpKotaDialogState createState() => _ListUpKotaDialogState();
}

class _ListUpKotaDialogState extends State<ListUpKotaDialog> {
