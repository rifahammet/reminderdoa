...
class SaldoAkhirBarangPage extends StatefulWidget {
  final bool? isViewOnly;
  const SaldoAkhirBarangPage({Key? key, this.isViewOnly}) : super(key: key);
  @override
  _SaldoAkhirBarangPageState createState() => _SaldoAkhirBarangPageState();
}

class _SaldoAkhirBarangPageState extends State<SaldoAkhirBarangPage> {
  ...
  Future getData(
    ...
    final dataPropinsi = auth.getGlobalParam(
        namaApi: "postingsisasaldoqtybank",
        where: { "bank_id": Prefs.getInt("bank_id"),"sisa<>": 0},
    ...
    var dataSave = [
      {
        "storesampahdetail": {
          ...
          "data": [
            {"posted_barang": 1,
            "dt_posted_barang": Fungsi().fmtDateTimeYearNow(),
            "posted_user_profile_id": Prefs.getInt("userId")
            }
          ],
          "where": {
            "posted_barang": 0,
