...
class SaldoAkhirBankPage extends StatefulWidget {
  final bool? isViewOnly;
  const SaldoAkhirBankPage({Key? key, this.isViewOnly}) : super(key: key);
  @override
  _SaldoAkhirBankPageState createState() => _SaldoAkhirBankPageState();
}

class _SaldoAkhirBankPageState extends State<SaldoAkhirBankPage> {
  ...
  Future getData(
    ...
    final dataPropinsi = auth.getGlobalParam(
        namaApi: "postingsisasaldobank",
        where: {"id": Prefs.getInt("bank_id")},
