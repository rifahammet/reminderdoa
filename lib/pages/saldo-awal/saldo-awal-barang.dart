...
import 'package:doa/pages/saldo-awal/form-saldo-awal-barang.dart';
...
class SaldoAwalBarangPage extends StatefulWidget {
  const SaldoAwalBarangPage({Key? key}) : super(key: key);
  @override
  _SaldoAwalBarangPageState createState() => _SaldoAwalBarangPageState();
}

class _SaldoAwalBarangPageState extends State<SaldoAwalBarangPage> {
  ...
  editData(BuildContext context, dynamic data, bool isEdit, bool isView) async {
    ...
    final x = await showDialog(
      context: context,
      builder: (BuildContext context) =>  SaldoAwalBarangDialog()
  ...
  Future getData(
    ...
    final dataPropinsi = auth.getGlobalParam(
        namaApi: "saldoawalbarang",whereIn: [
          "bank_id",
  ...
  callBackIsiWidget(index) {
    Widget wg = Column(
      ...
      children: <Widget>[
        ...
        SizedBox(height: 5,),
        Text(
          Fungsi().format(double.parse(newData?[index]['qty']),  isInteger: false),
          style: TextStyle(color: Colors.grey[700], fontSize: 12),
        ),
      ],
    );
                          ...
                          return Column(
                            children: <Widget>[
                              ...
                              DataTablet().getListData(
                                  ...
                                  isDeleteOnly: true,
                                  filePNG: "assets/images/widget-icons/recycling.png",
                                  isKlik: isKlik,
                                  warna: Colors.green,
