...
import 'package:doa/pages/saldo-awal/form-saldo-awal-bank.dart';
...
class SaldoAwalBankPage extends StatefulWidget {
  const SaldoAwalBankPage({Key? key}) : super(key: key);
  @override
  _SaldoAwalBankPageState createState() => _SaldoAwalBankPageState();
}

class _SaldoAwalBankPageState extends State<SaldoAwalBankPage> {
  ...
  editData(BuildContext context, dynamic data, bool isEdit, bool isView) async {
    ...
    final x = await showDialog(
      context: context,
      builder: (BuildContext context) =>  SaldoAwalBankDialog()
                          ...
                          return Column(
                            children: <Widget>[
                              ...
                              DataTablet().getListData(
                                  ...
                                  isDeleteOnly: true,
                                  filePNG: "assets/images/widget-icons/bank.png",
                                  isKlik: isKlik,
                                  warna: Colors.green,
