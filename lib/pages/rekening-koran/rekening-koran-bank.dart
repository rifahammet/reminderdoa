...
class RekeningKoranBankPage extends StatefulWidget {
  final bool? isViewOnly;
  const RekeningKoranBankPage({Key? key, this.isViewOnly}) : super(key: key);
  @override
  _RekeningKoranBankPageState createState() => _RekeningKoranBankPageState();
}

class _RekeningKoranBankPageState extends State<RekeningKoranBankPage> {
  ...
  Future getData(
    ...
    //     limit: _selectedType);
    if (vDatas["data"]["data"][0]["rekeningkoranbank"].length > 0) {
      vDatas["data"]["data"][0]["rekeningkoranbank"].add({
        "id": "",
        "bank_nama": "Saldo Akhir",
        "bank_id": "",
        "ket": "Saldo Akhir",
        "urut": "",
        "tgl": "",
    ...
    setState(() {
      newData = vDatas["data"]["data"][0]["rekeningkoranbank"];
    });
    return vDatas["data"]["data"][0]["rekeningkoranbank"];
  }
  ...
  callBackIsiWidget(index) {
    if (isReset) {
      if (newData?[index]['bank_nama'] != "Saldo Akhir") {
        if (newData?[index]['urut'] == "4" || newData?[index]['urut'] == "5") {
    ...
    Widget wg = Container(
      ...
      child: newData?[index]["bank_nama"] != "Saldo Akhir"
          ? Padding(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        <html>
          ...
          <body>
            <h2>Report Rekening Koran Bank</h2>
             </br>
