...
import 'package:doa/pages/satuan/form-satuan.dart';
...
class SatuanPage extends StatefulWidget {
  const SatuanPage({Key? key}) : super(key: key);
  @override
...
class _SatuanPageState extends State<SatuanPage> {
  ...
  editData(BuildContext context, dynamic data, bool isEdit, bool isView) async {
   ...
   final x = await showDialog(
      context: context,
      builder: (BuildContext context) => SatuanDialog()
  ...
  Future getDataKebun(
    ...
    final dataPropinsi = auth.getGlobalParam(
        ...
        like: txtFilter.text.toString().trim() != ""
            ? {"deleted":0 ,"concat_field": txtFilter.text}
            : {"deleted":0},
                            ...
                            return Column(
                              children: <Widget>[
                                ...
                                DataTablet().getListData(
                                    ...
                                    isDeleteOnly: true,
                                    filePNG:
                                        "assets/images/widget-icons/purchase.png",
                                    isKlik: isKlik,
                                    warna: Colors.brown,
