...
class AddItemPenjualanDialog {
  ...
  final txtHargaJualController = TextEditingController();
  final txtHargaJualFocusnode = FocusNode();
...
/* end warna */
      ...
      barangHarga=data?[index]["harga_jual"];
      qty = data?[index]["qty"];
      ...
      txtHargaJualController.text=  Fungsi().format(barangHarga,  isInteger: false);
     ...
     // txtEmail.text = data.email;
      ...
      txtKeteranganController.text = '';
       txtHargaJualController.text="0.00";
    ...
    return StatefulBuilder(builder: (context, setState) {
      ...
      changeTextField(pil, val) {
        setState(() {
          ...
          if(pil == "Harga"){
            barangHarga = double.parse(Fungsi().fmtStringToInt(val).toString());
            txtTotalController.text = Fungsi().format(barangHarga * Fungsi().fmtStringToInt(txtQtyController.text.toString()),  isInteger: false); //(barangHarga * double.parse(val.toString())).toString();
          }
                    ...
                    child:  SingleChildScrollView(
                      child: Column(
                        children:  <Widget>[
                          ...
                          TextBox().textboxWithBorderValidate(context,
                          label: "Harga",
                          textController: txtHargaJualController,
                          textChange: changeTextField,
                          textFocusNote: txtHargaJualFocusnode,
                          isNumber: true,
                          textSuffix: " /"+satuan,
                          ),
                          TextBox().textboxWithBorderValidate(context,
