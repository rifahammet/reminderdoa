...
class CheckBox {
  late final List<String> labels = ["Active", "Not Active"];
  Widget checkBox(
      {lebars, checkBoxLabel, bool? boolValue, cbOnChage, isUpDown = false}) {
    var wg = Container(
        ...
        child: IgnorePointer(
            ...
            child: FlutterToggleTab(
              ...
              selectedBackgroundColors: [
                index == 0 ? Colors.green : selectedColor
              ],
              ...
              labels: isActive ? labels : listLabel,
              icons: listIcon,
